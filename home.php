...
">
	...
	<?php
	if(!isset($_SESSION['id'])){ header( "Location :/FS/index.php" ); }
		...
		<div class="row row-style-login-page-pannel">
			<div class=" col-md-4 col-sm-6 col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="background: linear-gradient(to right, rgb(31, 28, 44), rgb(146, 141, 171));color:floralwhite;"># 1</div>
			...
			<div class=" col-md-4 col-sm-6 col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="background: linear-gradient(to right, rgb(31, 28, 44), rgb(146, 141, 171));color:floralwhite;"># 2</div>
					<div class="panel-body">
			...
			<div class=" col-md-4 col-sm-6 col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="background: linear-gradient(to right, rgb(31, 28, 44), rgb(146, 141, 171));color:floralwhite;"># 3</div>
					<div class="panel-body" >
			...
			<div class=" col-md-4 col-sm-6 col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="background: linear-gradient(to right, rgb(31, 28, 44), rgb(146, 141, 171));color:floralwhite;"># 4</div>
					<div class="panel-body" >
			...
			<div class=" col-md-4 col-sm-6 col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="background: linear-gradient(to right, rgb(31, 28, 44), rgb(146, 141, 171));color:floralwhite;"># 5</div>
					<div class="panel-body" >
			...
			<div class=" col-md-4 col-sm-6 col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="background: linear-gradient(to right, rgb(31, 28, 44), rgb(146, 141, 171));color:floralwhite;"># 6</div>
					<div class="panel-body">
